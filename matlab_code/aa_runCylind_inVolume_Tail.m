...
datapath = 'C:\Users\bigting84\Desktop\Lab_groupMeeting\2021\matlab_analysis\FEP_namd\la0\tail_dir';
list = dir(fullfile(datapath, 'tail*.csv'));
numData=[];
Lmin=p(3)-min(z); % 
