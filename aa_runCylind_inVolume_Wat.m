...
datapath = 'C:\Users\bigting84\Desktop\Lab_groupMeeting\2021\matlab_analysis\FEP_namd\la0\wat_dir';
list = dir(fullfile(datapath, 'wat_*.csv'));
numData=[];
Lmin=p(3)-min(z); %  
Lmax=p(3)-min(z)+9; % Lmin-Lmax is defined as hydrophobic constriction site.
...
dlmwrite('la0_Wat_numPore.txt',numData)
